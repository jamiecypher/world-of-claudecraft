...
describe('locomotionTimeScale', () => {
  ...
  it('lets a rig raise the cadence ceilings past the stock clamp', () => {
    ...
    expect(locomotionTimeScale('run', fast, undefined, 7.64, undefined, 2)).toBeCloseTo(1.649);
    expect(locomotionTimeScale('run', fast, undefined, 7.16, undefined, 2)).toBeCloseTo(1.76);
    ...
    expect(
      locomotionTimeScale('run', { speed: 7, backwards: false }, undefined, 7, undefined, 2),
    ).toBeCloseTo(1);
  });
